...
struct TwentyQuestionsView: View {
    ...
    @State private var isWordHidden = false
    ...
    var body: some View {
        VStack {
            if !isGameActive {
                ...
                VStack(spacing: 30) {
                    VStack(spacing: 10) {
                        Text(isWordHidden ? "Word is hidden" : "Your word is:")
                            .font(.title2)
                            .foregroundColor(.secondary)
                        
                        Text(isWordHidden ? "Hidden" : currentItem)
                            .font(.system(size: 50))
                            .fontWeight(.bold)
                            .foregroundColor(.orange)
                        
                        Text(isWordHidden ? "🫥" : itemEmoji)
                            .font(.system(size: 80))
                    }
                    ...
                    HStack(spacing: 30) {
                        ...
                        Button(action: toggleWordVisibility) {
                            Image(systemName: isWordHidden ? "eye.slash.fill" : "eye.fill")
                                .font(.system(size: 50))
